...
export default function Landing() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-hidden cursor-crosshair">
      ...
      {/* Enhanced Burgundy Tint with Depth */}
      <div
        className="absolute inset-0"
        style={{
          background: 'radial-gradient(circle, rgba(125,30,30,0.15) 0%, rgba(80,20,20,0.20) 50%, rgba(0,0,0,0.3) 100%)',
        }}
      />

      {/* Content - Premium Layout with Perfect Vertical Rhythm */}
      <div className="relative z-10 flex flex-col items-center justify-between min-h-screen px-4 lg:px-6 py-[6vh]">

        {/* 1. TOP: "those who dare" SVG Logo */}
        <div
          className="animate-fade-in w-full max-w-xs sm:max-w-sm lg:max-w-md opacity-80"
          style={{
        ...
        <div className="flex flex-col items-center gap-[8vh]">
          ...
          <div
            className="animate-fade-in w-full max-w-full transition-transform duration-700 hover:scale-[1.01] drop-shadow-2xl"
            ...
            >
              <g>
                ...
                <path
                  ...
                  style={{
                    ...
                    strokeDashoffset: isDrawing ? 0 : (pathLengths[0] || 10000),
                    transition: `stroke-dashoffset ${isFirstVisit ? 10 : 2}s cubic-bezier(0.68, -0.55, 0.27, 1.55)`,
                  }}
                />
                {/* Path 2 - R */}
                <path
                  ...
                  style={{
                    ...
                    strokeDashoffset: isDrawing ? 0 : (pathLengths[1] || 10000),
                    transition: `stroke-dashoffset ${isFirstVisit ? 10 : 2}s cubic-bezier(0.68, -0.55, 0.27, 1.55)`,
                  }}
                />
                {/* Path 3 - E */}
                <path
                  ...
                  style={{
                    ...
                    strokeDashoffset: isDrawing ? 0 : (pathLengths[2] || 10000),
                    transition: `stroke-dashoffset ${isFirstVisit ? 10 : 2}s cubic-bezier(0.68, -0.55, 0.27, 1.55)`,
                  }}
                />
                {/* Path 4 - N */}
                <path
                  ...
                  style={{
                    ...
                    strokeDashoffset: isDrawing ? 0 : (pathLengths[3] || 10000),
                    transition: `stroke-dashoffset ${isFirstVisit ? 10 : 2}s cubic-bezier(0.68, -0.55, 0.27, 1.55)`,
                  }}
                />
              </g>
              ...
              <path
                ...
                style={{
                  ...
                  strokeDashoffset: isDrawing ? 0 : (pathLengths[4] || 10000),
                  transition: `stroke-dashoffset ${isFirstVisit ? 5 : 2}s cubic-bezier(0.68, -0.55, 0.27, 1.55)`,
                }}
              />
            </svg>
          </div>
        ...
        {/* 3. BOTTOM: Icon with TRUE Stroke-Dasharray Path Drawing */}
        <div
        ...
        >
          ...
          <div
            className="relative w-[180px] h-[120px] py-4 flex items-center justify-center transition-all duration-500 hover:scale-105 hover:-translate-y-1"
            style={{
          ...
          >
            ...
            {/* Icon with Premium Subtle Glow */}
            <div className="premium-glow-icon">
              <img
                src="/images/icon/icon-maroon.svg"
                alt="Arena Boxing"
                className="w-[140px] h-[87px] object-contain"
                style={{ imageRendering: 'crisp-edges' }}
              />
            </div>
          </div>
          ...
          {/* Countdown Text */}
          <p className="mt-4 text-cream-primary/40 text-[11px] leading-none font-[family-name:var(--font-body)] animate-countdown-pulse">
            {countdown}s
          </p>
